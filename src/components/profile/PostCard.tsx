        ...
        <div className={styles.item_post}>
            ...
            <div className={styles.section_container}>
                <div className={styles.section_row}>
                    ...
                    <div className={styles.section_item_block}>
                    <div className={styles.section_name_text}>{i18next('employee.rate')}</div>
                ...
                <div className={styles.section_row}>
                    <div className={styles.section_item_block}>
                        <div className={styles.section_name_text}>{i18next('employee.date_start')}</div>
                        <div className={styles.section_base_text}>{props.post.dateStart}</div>
                    </div>

                    <div className={styles.section_item_block}>
                        <div className={styles.section_name_text}>{i18next('employee.date_end')}</div>
